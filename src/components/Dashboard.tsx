  ...
  return <div className="min-h-screen animated-wave-bg pb-20">
      ...
      <div className="p-2 flex justify-between items-start">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Button variant="ghost" className="bg-gradient-card card-glow hover:bg-white/20 hover:text-gray-900 text-white h-10 px-3 gap-2 hover:scale-105 transition-transform duration-200">
            <span className="text-sm font-bold">{currentXP} pts</span>
            <span className="text-xs opacity-80">Nivel {level}</span>
          </Button>
          
          {/* Botón de notificaciones */}
          <Button variant="ghost" size="icon" className="bg-gradient-card card-glow hover:bg-white/20 hover:text-gray-900 text-white h-10 w-10 hover:scale-105 transition-transform duration-200">
            ...
            <CarouselItem className="pl-2 md:pl-4 basis-[85%] md:basis-[80%]">
              <Card className="relative overflow-hidden border border-border/50 h-[200px] sm:h-[240px]">
                ...
                <div className="relative p-6 h-full flex flex-col justify-center">
                  ...
                  <Button variant="outline" size="sm" className="text-xs sm:text-sm bg-gradient-card card-glow text-white border-white/30 hover:bg-white/20 hover:text-gray-900 w-fit hover:scale-105 transition-transform duration-200">
                    Comprar Ahora
                  </Button>
                </div>
              </Card>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 animated-wave-bg border-t border-white/20 shadow-lg">
        <div className="container mx-auto px-2">
          <div className="flex items-center justify-around h-16">
            <Button variant="ghost" size="sm" className="flex flex-col items-center gap-1 h-auto py-2 px-3 text-purple-400 hover:bg-white/10 hover:text-gray-900 hover:scale-105 transition-transform duration-200" onClick={() => navigate("/dashboard")}>
              <Home className="w-5 h-5" />
              <span className="text-xs">Home</span>
            </Button>

            <Button variant="ghost" size="sm" className="flex flex-col items-center gap-1 h-auto py-2 px-3 text-white hover:bg-white/10 hover:text-gray-900 hover:scale-105 transition-transform duration-200" onClick={() => navigate("/analysis")}>
              <BarChart3 className="w-5 h-5" />
              <span className="text-xs">Análisis</span>
            </Button>

            <Button variant="ghost" size="sm" className="flex flex-col items-center gap-1 h-auto py-2 px-3 text-white hover:bg-white/10 hover:text-gray-900 hover:scale-105 transition-transform duration-200" onClick={() => navigate("/goals")}>
              <Target className="w-5 h-5" />
              <span className="text-xs">Metas</span>
            </Button>

            <Button variant="ghost" size="sm" className="flex flex-col items-center gap-1 h-auto py-2 px-3 text-white hover:bg-white/10 hover:text-gray-900 hover:scale-105 transition-transform duration-200" onClick={() => navigate("/chat")}>
              <MessageCircle className="w-5 h-5" />
              <span className="text-xs">Chat AI</span>
            </Button>

            <Button variant="ghost" size="sm" className="flex flex-col items-center gap-1 h-auto py-2 px-3 text-white hover:bg-white/10 hover:text-gray-900 hover:scale-105 transition-transform duration-200" onClick={() => navigate("/profile")}>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <div className="flex flex-row justify-between items-center mb-4">
                ...
                <Button size="sm" onClick={() => navigate('/new-goal')} className="bg-gradient-card card-glow hover:bg-white/30 hover:text-gray-900 text-white border-white/30 text-xs sm:text-sm hover:scale-105 transition-transform duration-200">
              ...
              <div className="space-y-3 sm:space-y-4">
                {goals.length === 0 ? <Card className="p-6 bg-gradient-card card-glow text-center">
                    ...
                    <Button size="sm" onClick={() => navigate('/new-goal')} className="bg-gradient-card card-glow hover:bg-white/30 hover:text-gray-900 text-white hover:scale-105 transition-transform duration-200">
          ...
          <div className="space-y-6">
            ...
            <Card className="p-4 sm:p-6 bg-gradient-card card-glow">
              ...
              <Button size="sm" className="w-full bg-gradient-card card-glow hover:bg-white/30 hover:text-gray-900 text-white border-white/30 hover:scale-105 transition-transform duration-200" onClick={() => navigate("/chat")}>
            ...
            <Card className="p-4 sm:p-6 bg-gradient-card card-glow">
              ...
              <Button size="sm" className="w-full bg-gradient-card card-glow hover:bg-white/30 hover:text-gray-900 text-white border-white/30 hover:scale-105 transition-transform duration-200" onClick={() => navigate("/analysis")}>
            ...
            <Card className="p-4 sm:p-6 bg-gradient-card card-glow">
              <div className="flex justify-between items-center mb-4">
                ...
                <Button variant="ghost" size="sm" className="text-xs text-white hover:bg-white/10 hover:text-gray-900 hover:scale-105 transition-transform duration-200">
                  Ver todos
                </Button>
              </div>
              <div className="space-y-3">
