      ...
      <div className="mx-4 space-y-4 sm:space-y-6 overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6 w-full">
            <div>
              ...
              <div className="space-y-3 sm:space-y-4">
                {goals.length === 0 ? (
                  <Card className="w-full p-4 sm:p-6 bg-white rounded-[20px] shadow-xl border border-blue-100 relative overflow-hidden text-center animate-fade-in">
                ...
                return <Card key={goal.id} className={`w-full p-4 sm:p-6 bg-gradient-to-br ${gradient} card-glow shadow-2xl border-2 relative overflow-hidden hover:scale-105 transition-transform duration-200 animate-fade-in`} style={{
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  {challenges.slice(0, 2).map((challenge, index) => {
                    ...
                    return (
                      <Card 
                        key={challenge.id} 
                        className="w-full p-2.5 bg-white rounded-[20px] shadow-xl border border-blue-100 relative overflow-hidden"
          ...
          <div className="space-y-4 sm:space-y-6 w-full">
            ...
            {/* Recent Transactions */}
            <Card className="w-full p-3 bg-white rounded-[20px] shadow-xl border border-blue-100 relative overflow-hidden h-[220px] flex flex-col cursor-pointer">
              <GlowingEffect
                spread={40}
                glow={true}
                disabled={false}
