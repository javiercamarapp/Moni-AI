  ...
  return (
    <>
      ...
      <Dialog open={showDetailsDialog} onOpenChange={setShowDetailsDialog}>
        <DialogContent 
          className={`w-[90vw] sm:w-full max-w-[380px] rounded-3xl border-none shadow-2xl p-6 bg-gradient-to-br ${selectedComponent?.colors?.gradient || 'from-gray-100 to-gray-200'}`}
        >
