...
export const SCORE_COMPONENTS: ScoreComponent[] = [
  {
    ...
    score: 30,
    maxScore: 30,
    description: 'Tasa de ahorro mensual y fondo de emergencia.',
  ...
  },
  {
    ...
    score: 16,
    maxScore: 25,
    description: 'Endeudamiento y capacidad de pago.',
    color: 'bg-blue-500',
  ...
  },
  {
    ...
    score: 12,
    maxScore: 15,
    description: 'Presupuesto y gastos impulsivos.',
    color: 'bg-orange-500',
    IconComponent: Scale,
    trend: '+3 pts',
    details: {
  ...
  },
  {
    ...
    score: 8,
    maxScore: 10,
    description: 'Patrimonio neto e inversiones.',
    color: 'bg-pink-500',
