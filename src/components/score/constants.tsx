...
export const SCORE_COMPONENTS: ScoreComponent[] = [
  {
    ...
    score: 30,
    maxScore: 30,
    description: '% de ingreso ahorrado + liquidez disponible.',
  ...
  },
  {
    ...
    score: 16,
    maxScore: 25,
    description: 'Deuda total / ingreso + pagos a tiempo.',
    color: 'bg-blue-500',
  ...
  },
  {
    ...
    score: 18,
    maxScore: 20,
    description: 'Días con registro + metas cumplidas.',
    color: 'bg-purple-500',
  ...
  },
  {
    ...
    score: 12,
    maxScore: 15,
    description: 'Gasto real vs presupuesto asignado.',
    color: 'bg-orange-500',
    IconComponent: Scale,
    trend: '+3 pts',
    details: {
  ...
  },
  {
    ...
    score: 8,
    maxScore: 10,
    description: 'Δ patrimonio mensual + rendimientos.',
    color: 'bg-pink-500',
