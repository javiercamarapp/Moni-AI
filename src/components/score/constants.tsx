...
export const SCORE_COMPONENTS: ScoreComponent[] = [
  {
    ...
    score: 30,
    maxScore: 30,
    description: 'Evalúa el % de ingreso que ahorras mensualmente y tu fondo de emergencia disponible.',
  ...
  },
  {
    ...
    score: 16,
    maxScore: 25,
    description: 'Mide tu ratio deuda/ingreso mensual y tu historial de pagos puntuales.',
    color: 'bg-blue-500',
  ...
  },
  {
    ...
    score: 18,
    maxScore: 20,
    description: 'Considera los días que registras gastos y las metas de presupuesto cumplidas.',
    color: 'bg-purple-500',
  ...
  },
  {
    ...
    score: 12,
    maxScore: 15,
    description: 'Compara tu gasto real contra el presupuesto asignado por categoría.',
    color: 'bg-orange-500',
    IconComponent: Scale,
    trend: '+3 pts',
    details: {
  ...
  },
  {
    ...
    score: 8,
    maxScore: 10,
    description: 'Analiza el cambio mensual de tu patrimonio neto y rendimientos de inversión.',
    color: 'bg-pink-500',
