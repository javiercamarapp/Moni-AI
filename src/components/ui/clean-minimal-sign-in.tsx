...
const SignIn2 = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-start pt-[50vh] rounded-xl z-1">
      <div className="w-full max-w-[320px] bg-gradient-to-b from-sky-50/50 to-white rounded-3xl shadow-xl shadow-opacity-10 pt-3 px-6 pb-[60vh] flex flex-col items-center border border-blue-100 text-black -mt-16">
