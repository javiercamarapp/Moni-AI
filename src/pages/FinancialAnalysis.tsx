        ...
        {analysis && <>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button variant="outline" size="sm" className="bg-gradient-card card-glow border-white/20 text-white hover:scale-105 active:scale-95 transition-transform duration-200 text-xs h-auto py-2">
                  Ajustar presupuesto
                </Button>
                <Button variant="outline" size="sm" className="bg-gradient-card card-glow border-white/20 text-white hover:scale-105 active:scale-95 transition-transform duration-200 text-xs h-auto py-2">
                  Plan de deudas
