              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    left: `${badgeX}%`,
                    transform: 'translate(-50%, -50%)',
                    zIndex: expandedBadge === 'inversor8500' ? 100 : 20
                  }}
                >
                  <div className="flex flex-col items-center gap-0.5 relative">
                    <button
                      onClick={() => {
                        if (isUnlocked) {
                          setExpandedBadge(expandedBadge === 'inversor8500' ? null : 'inversor8500');
                          setExpandedNode(null);
                        }
                      }}
                      disabled={!isUnlocked}
                    ...
                    >
                      <div
                        className={`
                          relative w-12 h-12 rounded-full flex items-center justify-center
                          transition-all duration-300 border-2 border-green-300 cursor-pointer
                          bg-gradient-to-br from-green-500 via-emerald-600 to-teal-700 shadow-2xl
                          ${isUnlocked ? 'shadow-2xl hover:scale-110 animate-pulse' : 'grayscale cursor-not-allowed opacity-50'}
                        `}
                      >
                        {isUnlocked && (
                        ...
                        <TrendingUp className="w-7 h-7 text-white relative z-10 drop-shadow-md" />
                      </div>
                    </button>
                    ...
                    {/* Card de descripción expandida */}
                    {expandedBadge === 'inversor8500' && isUnlocked && (
                      <Card 
                        className="absolute bg-white/95 backdrop-blur-sm rounded-[20px] shadow-xl
                          border-0 w-64 max-w-[calc(100vw-40px)] animate-scale-in overflow-hidden top-full mt-3 left-1/2 -translate-x-1/2"
                      >
                        ...
                        <div className="relative p-3">
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-500 via-emerald-600 to-teal-700 flex items-center justify-center shrink-0">
                              <TrendingUp className="w-5 h-5 text-white" />
                            </div>
                            <h3 className="text-base font-bold text-gray-900">Inversor 💹</h3>
                          </div>
                          
                          <p className="text-xs text-gray-600 mb-2 leading-relaxed">
                            Has alcanzado el nivel 8,500. Tu capital crece exponencialmente gracias a tus decisiones estratégicas de inversión.
                          </p>
