...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-2xl bg-white/20 flex items-center justify-center glow-primary backdrop-blur-sm">
            ...
            <div className="space-y-4 max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight">
                ...
                <span className="text-gray-300"> IA y WhatsApp</span>
              </h2>
            ...
            <div className="flex flex-col items-center space-y-2 pt-8">
              ...
              <p className="text-xs text-gray-400">Por cada suscripción pagada, donamos una a un estudiante</p>
            </div>
          </div>
        </div>
      ...
      {/* Features Section */}
      <section className="px-4 py-8 sm:py-12 bg-black/30 backdrop-blur-sm">
        <div className="container mx-auto max-w-6xl">
      ...
      <section className="px-4 py-8 sm:py-12">
        <div className="container mx-auto max-w-4xl text-center">
          <Card className="p-12 bg-gradient-card card-glow border-white/20 hover:scale-105 transition-transform duration-200">
