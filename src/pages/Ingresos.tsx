      ...
      <div className="max-w-5xl mx-auto min-h-screen flex flex-col p-6">
                ...
                return (
                  ...
                  >
                    <div className="w-9 h-9 rounded-xl bg-[#EFEBE9] flex items-center justify-center flex-shrink-0">
                      <Landmark className="w-4 h-4 text-[#5D4037]" />
                    </div>
        ...
        <div className="fixed bottom-24 right-6 z-50">
          ...
          <motion.button
            ...
            className="w-14 h-14 rounded-full bg-[#A1887F] text-white shadow-xl flex items-center justify-center hover:bg-[#8D6E63] transition-colors"
            whileTap={{ scale: 0.95 }}
          >
            <motion.div
