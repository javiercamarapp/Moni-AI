        ...
        <div className="min-h-screen bg-background flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 pb-12 -mt-20 relative z-10">
            <div className="max-w-md text-center space-y-6">
              ...
              <Button 
                size="lg"
                className="w-full mt-8 text-base py-6 bg-white/80 backdrop-blur-sm rounded-3xl shadow-sm hover:shadow-md transition-all font-semibold border-0 text-gray-900 animate-fade-in"
